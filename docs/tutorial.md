...
multipass launch 24.04 --cpus 4 --memory 8G --disk 50G --name my-vm --timeout 1800 --cloud-init https://raw.githubusercontent.com/canonical/multipass/refs/heads/main/data/cloud-init-yaml/cloud-init-charm-dev.yaml
```
...
tutorial  overlord    localhost/localhost  3.6.13   unsupported  15:31:14+02:00
...
Model     Controller  Cloud/Region         Version  SLA          Timestamp
tutorial  overlord    microk8s/localhost   3.6.13   unsupported  15:31:14+02:00
...
```{caution}
This part of the tutorial accesses MySQL through the `charmed-operator` user. 
...
Integrations automatically create a username, password, and database for the desired user/application. The best practice is to connect to MySQL through a specific user rather than the admin user, like we did earlier with the `charmed-operator` user.
...
```text
Model     Controller  Cloud/Region         Version  SLA          Timestamp
tutorial  overlord    localhost/localhost  3.6.13   unsupported  22:54:31+01:00
...
```text
Model     Controller  Cloud/Region         Version  SLA          Timestamp
tutorial  overlord    localhost/localhost  3.6.13   unsupported  22:55:44+01:00
